...
public class DAGTest {
	...
	public void testCycle()
	{
		...
		assertEquals(acyclic.hasCycle(), false);//it is acyclic
	...
	public void testLCA()
	{
		...
		assertEquals(acyclic.findLCA(2, 3), 3);
		...
		assertEquals(3, directAcyclic.findLCA(3, 3));
		...
		assertThrows(IllegalArgumentException.class, () -> {emptyG.findLCA(3, 3);});
	}
	...
	public void testLCAError()
	{
		...
		assertThrows(IllegalArgumentException.class, () -> {cycle.findLCA(100, 40);});
		assertThrows(IllegalArgumentException.class, () -> {cycle.findLCA(-1, 4);});
		
		//Acyclic Graph Error Tests
		assertThrows(IllegalArgumentException.class, () -> {acyclic.findLCA(-1, 4);});
		assertThrows(IllegalArgumentException.class, () -> {acyclic.findLCA(1, 40);});
		assertThrows(IllegalArgumentException.class, () -> {acyclic.findLCA(100, 400);});
		
		//Direct Acyclic Graph Error Tests
		assertThrows(IllegalArgumentException.class, () -> {directAcyclic.findLCA(-1, 4);});
		assertThrows(IllegalArgumentException.class, () -> {directAcyclic.findLCA(1, 40);});
		assertThrows(IllegalArgumentException.class, () -> {directAcyclic.findLCA(100, 400);});
	}
